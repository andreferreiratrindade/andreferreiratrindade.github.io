...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UsuarioEntity", function() { return UsuarioEntity; });
class UsuarioEntity {
}
...
/* harmony import */ var src_app_entity_usuario_entity__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/entity/usuario-entity */ "./src/app/entity/usuario-entity.ts");
...
let SignUpPage = class SignUpPage {
    constructor(angularFire, router, ngZone, authService, usuarioService) {
    ...
    signUpWithEmail() {
        this.authService.signUpWithEmail(this.signUpForm.value['email'], this.signUpForm.value['password'])
            ...
            let usuarioObj = new src_app_entity_usuario_entity__WEBPACK_IMPORTED_MODULE_7__["UsuarioEntity"]();
